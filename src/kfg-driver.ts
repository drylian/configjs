import type { inPromise, SchemaDefinition } from "./types";
...
export abstract class KfgDriver<
	Config extends Record<string, any>,
	Async extends boolean,
> {
	...
	): inPromise<Async, Record<string, any>>;
	...
	/**
	 * Optional transactional read-modify-write. When implemented, Kfg.mutate()
